...
def main():
    ...
    scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=10, gamma=0.5)  # 使用学习率调度器
...
final_model_path = "NNAttemps/FinalNN/models/final_light_probe_model_MATERIALPNGBETTER.pth"
