...
class CustomDataset(Dataset):
    def __init__(self, folder_path, limit=None):
        ...
        for batch_folder in os.listdir(folder_path):
            ...
            if hitpos_exr_path and raydir_exr_path and normal_exr_path and color_png_path:
...
final_model_path = "NNAttemps/ShuffledNN2/models/final_light_probe_model_morePNGNormal.pth"
